...
replace pkg.berachain.dev/polaris/cosmos => ../cosmos
...
require (
	...
	pkg.berachain.dev/polaris/cosmos v0.0.0-00010101000000-000000000000
)
...
require (
	...
	pkg.berachain.dev/polaris/eth v0.0.0-20230720022139-37f587ddf39e // indirect
